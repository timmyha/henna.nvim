...
M.base = {
    ...
    ["@markup.heading.1.markdown"] = { fg = colors.bg, bg = colors.yellow, style = "bold" },
    ["@markup.heading.2.markdown"] = { fg = colors.bg, bg = colors.green, style = "bold" },
    ["@markup.heading.3.markdown"] = { fg = colors.bg, bg = colors.orange, style = "bold" },
    ["@markup.heading.4.markdown"] = { fg = colors.bg, bg = colors.pink, style = "bold" },
    ["@markup.heading.5.markdown"] = { fg = colors.bg, bg = colors.gray, style = "bold" },
    ["@markup.heading.6.markdown"] = { bg = "none", fg = colors.diff_change, style = "bold" },
    ["@markup.quote"] = { fg = colors.yellow },
    RenderMarkdownH1Bg = { bg = colors.yellow, fg = colors.bg, style = "bold" },
    RenderMarkdownH2Bg = { fg = colors.bg, bg = colors.green, style = "bold" },
    RenderMarkdownH3Bg = { fg = colors.bg, bg = colors.orange, style = "bold" },
    RenderMarkdownH4Bg = { fg = colors.bg, bg = colors.pink, style = "bold" },
    RenderMarkdownH5Bg = { fg = colors.bg, bg = colors.gray, style = "bold" },
    RenderMarkdownH6Bg = { fg = colors.diff_change, bg = "none", style = "bold" },
