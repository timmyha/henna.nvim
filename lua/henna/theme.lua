...
M.base = {
    ...
    ["@markup.heading.1.markdown"] = { bg = colors.fg, fg = colors.pink },
    ["@markup.heading.2.markdown"] = { bg = colors.fg, fg = colors.green },
    ["@markup.heading.3.markdown"] = { bg = colors.fg, fg = colors.orange },
    ["@markup.heading.4.markdown"] = { bg = colors.fg, fg = colors.yellow },
    ["@markup.heading.5.markdown"] = { bg = colors.fg, fg = colors.gray },
    ["@markup.heading.6.markdown"] = { bg = colors.bg, fg = colors.fg },
    RenderMarkdownH1Bg = { fg = colors.pink, bg = colors.fg },
    RenderMarkdownH2Bg = { fg = colors.green, bg = colors.fg },
    RenderMarkdownH3Bg = { fg = colors.orange, bg = colors.fg },
    RenderMarkdownH4Bg = { fg = colors.yellow, bg = colors.fg },
    RenderMarkdownH5Bg = { fg = colors.gray, bg = colors.fg },
    RenderMarkdownH6Bg = { fg = colors.fg, bg = colors.bg },
