...
M.base = {
    ...
    ["@markup.heading.1.markdown"] = { bg = colors.bg, fg = colors.pink },
    ["@markup.heading.2.markdown"] = { bg = colors.bg, fg = colors.green },
    ["@markup.heading.3.markdown"] = { bg = colors.bg, fg = colors.orange },
    ["@markup.heading.4.markdown"] = { bg = colors.bg, fg = colors.yellow },
    ["@markup.heading.5.markdown"] = { bg = colors.bg, fg = colors.gray },
    ["@markup.heading.6.markdown"] = { bg = colors.bg, fg = colors.diff_change },
    RenderMarkdownH1Bg = { fg = colors.pink, bg = colors.bg },
    RenderMarkdownH2Bg = { fg = colors.green, bg = colors.bg },
    RenderMarkdownH3Bg = { fg = colors.orange, bg = colors.bg },
    RenderMarkdownH4Bg = { fg = colors.yellow, bg = colors.bg },
    RenderMarkdownH5Bg = { fg = colors.gray, bg = colors.bg },
    RenderMarkdownH6Bg = { fg = colors.diff_change, bg = colors.bg },
