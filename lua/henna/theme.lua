...
M.base = {
    ...
    ["@markup.heading.1.markdown"] = { bg = "none", fg = colors.yellow, style = "bold" },
    ["@markup.heading.2.markdown"] = { bg = "none", fg = colors.green, style = "bold" },
    ["@markup.heading.3.markdown"] = { bg = "none", fg = colors.orange, style = "bold" },
    ...
    ["@markup.list.unordered.markdown"] = { fg = colors.pink },
    ["@markup.list.checked.markdown"] = { fg = colors.yellow },
    ["@markup.list.unchecked.markdown"] = { fg = colors.pink },
    ["@markup.inline.raw.markdown"] = { bg = colors.code, fg = colors.yellow },
    ["@markup.inline.code.markdown"] = { bg = colors.code, fg = colors.yellow },
    ...
    RenderMarkdownH4Bg = { fg = colors.pink, bg = "none", style = "bold" },
    RenderMarkdownH5Bg = { fg = colors.gray, bg = "none", style = "bold" },
