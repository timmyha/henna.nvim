...
M.base = {
    ...
    ["@markup.heading.1.markdown"] = { bg = "none", fg = colors.pink, style = "bold" },
    ...
    ["@markup.heading.4.markdown"] = { bg = "none", fg = colors.yellow, style = "bold" },
