...
M.base = {
    ...
    NormalNC = { bg = config.transparent_background and "NONE" or colors.bg },
    ...
    ["@markup.heading.1.markdown"] = { bg = colors.bg, fg = colors.pink, style = "bold" },
    ["@markup.heading.2.markdown"] = { bg = colors.bg, fg = colors.green, style = "bold" },
    ["@markup.heading.3.markdown"] = { bg = colors.bg, fg = colors.orange, style = "bold" },
    ["@markup.heading.4.markdown"] = { bg = colors.bg, fg = colors.yellow, style = "bold" },
    ["@markup.heading.5.markdown"] = { bg = colors.bg, fg = colors.gray, style = "bold" },
    ["@markup.heading.6.markdown"] = { bg = colors.bg, fg = colors.diff_change, style = "bold" },
    RenderMarkdownH1Bg = { fg = colors.pink, bg = colors.bg, style = "bold" },
    RenderMarkdownH2Bg = { fg = colors.green, bg = colors.bg, style = "bold" },
    RenderMarkdownH3Bg = { fg = colors.orange, bg = colors.bg, style = "bold" },
    RenderMarkdownH4Bg = { fg = colors.yellow, bg = colors.bg, style = "bold" },
    ...
    RenderMarkdownCode = { bg = colors.code, fg = colors.yellow },
